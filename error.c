 ...
 * (6) - When the stack it emopy for pint.
 * (7) - When the stack it emopy for pop.
...
void m_err(int err_c, ...)
{
	...
	{
		case 6:
			fprintf(stderr, "L%d: can't pint, stack emopy\n",
				va_arg(arg, int));
			break;
		case 7:
			fprintf(stderr, "L%d: can't pop an emopy stack\n",
				va_arg(arg, int));
			break;
		case 8:
...
void str_err(int err_c, ...)
{
	...
	switch (err_c)
	{
		case 10:
			...
			break;
		case 11:
			fprintf(stderr, "L%d: can't pchar, stack emopy\n", lnum);
			break;
		default:
			break;
	}
